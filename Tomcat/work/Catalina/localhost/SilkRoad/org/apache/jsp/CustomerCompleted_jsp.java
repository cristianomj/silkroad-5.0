 ...
 * Generated at: 2015-11-19 04:22:34 UTC
...
public final class CustomerCompleted_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
  ...
  final String username = session.getAttribute("login").toString();
	...
	// Will hold the auctions the user has taken part in
  ResultSet auctionHistoryRes = null;
  ...
  // Will hold all of the item types
	...
	try	{
		  ...
		  conn = java.sql.DriverManager.getConnection(DB_URL, USER, PASS);
			...
			cs = conn.prepareCall("call GetCustomerAuctionHistory(?)");
      cs.setString(1, username);
			cs.execute();

      // Extract the status and the return msg
      auctionHistoryRes = cs.getResultSet();
      // TODO. Error handling
      ...
      out.write("          <a class=\"open_nav\" href=\"CustomerCompleted.jsp\">Completed<span class=\"sr-only\">(current)</span></a>\r\n");
      out.write("        </li>\r\n");
 ...
 itemTypeRes.getString(1); 
      ...
      out.write("    <div>\r\n");
      out.write("\t\t\t<h4 style=\"text-align:center; color:black\">PARTICIPATING AUCTIONS</h4>\r\n");
      ...
      out.write("          ");
          ...
          while(auctionHistoryRes.next()) {
            
      out.write("\r\n");
      out.write("            <tr>\r\n");
      out.write("              <td>\r\n");
      out.write("                ");
      out.print(auctionHistoryRes.getString(1));
      out.write("\r\n");
      out.write("              </td>\r\n");
      out.write("              <td>\r\n");
      out.write("                ");
      out.print(auctionHistoryRes.getString(2));
      out.write("\r\n");
      out.write("              </td>\r\n");
      out.write("              <td>\r\n");
      out.write("                ");
      out.print(auctionHistoryRes.getInt(3));
      out.write("\r\n");
      out.write("              </td>\r\n");
      out.write("              <td>\r\n");
      out.write("                ");
 int hours = Integer.parseInt(auctionHistoryRes.getString(4).split(":")[0]);
                   int days = hours / 24;
