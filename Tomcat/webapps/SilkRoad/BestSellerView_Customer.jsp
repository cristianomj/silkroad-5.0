...
ResultSet topSoldCustmerRes = null;
           ...
           <ul class="nav">
            ...
            <body class="auctionHouseBody">
             <% cs = conn.prepareCall("call GetBestSellerList()");
            		cs.execute();
              cs.getMoreResults();
            		topSoldCustmerRes = cs.getResultSet();
            	%>
             <div id="container">
             <h4 class="auctionTableHeader">Best Selling Customers</h4>
             <table id ="itemSuggestionsTable" class="table table-striped table-bordered dt-responsive nowrap auctionHouseTable">
      								...
      								<tbody>
      									<% while(topSoldCustmerRes.next()) { %>
      									<tr>
      										<td>
      											<%= topSoldCustmerRes.getString("Username")%>
      										</td>
      										<td>
      											<%= topSoldCustmerRes.getString("ItemsSold") %>
      										</td>
      									</tr>
      									<% } %>
      								</tbody>
