...
<%
  ...
  // Will hold all of the item types
	...
	// Will hold the item suggestions
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      ...
      <ul class="nav">
        ...
        <li class="floatLeft"><a href="PostAuctionPage.jsp">Post</a></li>
          ...
          <a class="open_nav" href="CustomerAuctions.jsp">Completed<span class="sr-only">(current)</span></a>
        </li>
...
<body class="auctionHouseBody">
	...
	<div class="borderSidebar">
		<form name="myForm" id="customerSearchForm">
				...
				<div class="form-group greenShadowText">
					<div class = "controls regControl">
							<input name="searchByTypeBtn" class="btn btn-default" type="button" onclick="searchByType('user|all')" value="Search"/>
					</div>
				</div>
			<div class="form-group greenShadowText">
			...
			<div class="form-group greenShadowText">
				<div class = "controls regControl">
						<input name="searchBySellerBtn" class="btn btn-default" type="button" onclick="searchBySeller('user|all')" value="Search"/>
				</div>
			</div>
	</form> <!-- myForm -->
	</div> <!-- borderSidebar -->
  <div class="container auctionTable">
    <div>
			<h4 class="auctionTableHeader">PARTICIPATING AUCTIONS</h4>
      <div id="auctionData">
					<!-- filled with html we get from the ajax call -->
      </div>
      </div>
