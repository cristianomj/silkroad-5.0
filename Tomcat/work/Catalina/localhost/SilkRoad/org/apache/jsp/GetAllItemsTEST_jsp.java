 ...
 * Generated at: 2015-12-03 23:05:42 UTC
...
public final class GetAllItemsTEST_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 while(itemSuggestionRes.next()) { 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print( itemSuggestionRes.getString("Type") );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
