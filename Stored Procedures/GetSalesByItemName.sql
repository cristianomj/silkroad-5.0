delimiter $$
drop procedure if exists GetSalesByItemName;
create procedure GetSalesByItemName(
	ItemName	char(20)
)
deterministic
begin
...
select P1.Username, P2.Username, S.Price, S.`Date`, I.Name, I.`Type`, S.AuctionID
	...
	where I.ItemID = S.ItemID and P1.SSN = S.BuyerID and P2.SSN = S.SellerID and I.Name = ItemName
